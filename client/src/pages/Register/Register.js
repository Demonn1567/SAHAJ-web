      ...
      >
        ...
        {success && (
          <motion.div 
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            className="mb-6 p-4 bg-green-50/80 backdrop-blur-sm border-l-4 border-green-500 text-green-700 rounded-md"
          >
          ...
          >
            ...
            <div className="relative">
              ...
              <select
                ...
                value={formData.role}
                onChange={handleChange}
                className="pl-10 block w-full rounded-lg border border-gray-200 px-4 py-3 text-gray-900 focus:border-blue-500 focus:ring-blue-500 focus:ring-2 transition-all duration-200 bg-white/50 backdrop-blur-sm hover:bg-white/80 appearance-none"
                required
              >
